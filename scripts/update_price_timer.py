...
Использование:
    python scripts/update_price_timer.py --product-ids 123456,789012,345678
    python scripts/update_price_timer.py --all   # обновить для всех товаров в БД
"""
...
def parse_product_ids(arg: str) -> list[int]:
    """Парсит строку с product_id через запятую."""
