...
def upgrade() -> None:
    ...
    op.create_index('idx_history_product_timestamp', 'product_price_history', ['product_id', 'timestamp'])
    op.create_index('idx_marginality_product_timestamp', 'product_marginality_history', ['product_id', 'timestamp'])
    ...
    op.execute("INSERT OR IGNORE INTO maintenance (key, value) VALUES ('last_cleanup', '1970-01-01 00:00:00')")
