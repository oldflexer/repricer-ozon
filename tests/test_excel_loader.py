...
class TestExcelLoader:
    ...
    def test_update_product_in_file_not_found(self, mock_exists, loader):
        ...
        with patch("openpyxl.load_workbook") as mock_load_workbook:
            ...
            mock_ws.cell = Mock(side_effect=lambda row, col: header_cells[col-1] if row == 1 else data_cells[col-1])
    ...
    def test_build_excel_updates(self, loader):
        ...
        product = ProductInfo(
            sku="SKU1", cost_price=100, min_price=150, old_price=200
        )
        ...
        updates = loader.build_excel_updates(
            product, result, 
            marginality_week=24.0, 
            marginality_month=23.5,
            old_price_update=190
        )
